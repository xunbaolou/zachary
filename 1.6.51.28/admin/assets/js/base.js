...
jQuery(document).ready(function($) {
    ...
    if (typeof $.fn !== "undefined") {
        $.fn.serializeObjectLightSNS = FormSerializer.serializeObject;
        $.fn.serializeJSONLightSNS = FormSerializer.serializeJSON;
    }
    ...
    $(".jinsom-show-menu").click(function() {
        if ($(".jinsom-panel-nav").css('width') == '180px') {
            ...
            $('.jinsom-panel-nav.on ul li').hover(function() {}, function() {});
...
function jinsom_custom_verify_domain() {
    ...
    $.ajax({
        ...
        data: {
            domain: jinsom.domain,
            theme: jinsom.theme_name
        },
        success: function(msg) {
            layer.closeAll('loading');
            layer.msg(msg.msg);
