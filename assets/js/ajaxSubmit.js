...
! function(e) {
    ...
    function a(t) {
        ...
        var o = this;
        if (o.clk = a, "image" == a.type)
            if (void 0 !== t.offsetX) o.clk_x = t.offsetX, o.clk_y = t.offsetY;
            else if ("function" == typeof e.fn.offset) {
            var i = r.offset();
            o.clk_x = t.pageX - i.left, o.clk_y = t.pageY - i.top
        } else o.clk_x = t.pageX - a.offsetLeft, o.clk_y = t.pageY - a.offsetTop;
        setTimeout(function() {
    ...
    n.fileapi = void 0 !== e("<input type='file'/>").get(0).files, n.formdata = void 0 !== window.FormData, e.fn.ajaxSubmit = function(t) {
        function a(t) {
            var a, r, n = e.param(t).split("&"),
                o = n.length,
                i = {};
            for (a = 0; a < o; a++) r = n[a].split("="), i[decodeURIComponent(r[0])] = decodeURIComponent(r[1]);
            return i
        }
        ...
        function o(a) {
            ...
            function o() {
                function t() {
                    try {
                        ...
                        r("Server abort: ", e, " (", e.name, ")"), s(k), T && clearTimeout(T), T = void 0
                    }
                }
                var a = l.attr("target"),
                    o = l.attr("action");
                S.setAttribute("target", p), i || S.setAttribute("method", "POST"), o != f.url && S.setAttribute("action", f.url), f.skipEncodingOverride || i && !/post/i.test(i) || l.attr({
                ...
                try {
                    if (f.extraData)
                        for (var c in f.extraData) f.extraData.hasOwnProperty(c) && (e.isPlainObject(f.extraData[c]) && f.extraData[c].hasOwnProperty("name") && f.extraData[c].hasOwnProperty("value") ? u.push(e('<input type="hidden" name="' + f.extraData[c].name + '">').attr("value", f.extraData[c].value).appendTo(S)[0]) : u.push(e('<input type="hidden" name="' + c + '">').attr("value", f.extraData[c]).appendTo(S)[0]));
                    f.iframeTarget || (h.appendTo("body"), v.attachEvent ? v.attachEvent("onload", s) : v.addEventListener("load", s, !1)), setTimeout(t, 15), S.submit()
                } finally {
                    S.setAttribute("action", o), a ? S.setAttribute("target", a) : l.removeAttr("target"), e(u).remove()
                }
            }
            ...
            function s(t) {
                if (!g.aborted && !M) {
                    try {
                        ...
                        r("cannot access response document: ", e), t = k
                    }
                    if (t === j && g) return void g.abort("timeout");
                    if (t == k && g) return void g.abort("server abort");
                    if (E && E.location.href != f.iframeSrc || y) {
                        v.detachEvent ? v.detachEvent("onload", s) : v.removeEventListener("load", s, !1);
                        var a, o = "success";
                        try {
                            if (y) throw "timeout";
                            var i = "xml" == f.dataType || E.XMLDocument || e.isXMLDoc(E);
                            if (r("isXml=" + i), !i && window.opera && (null === E.body || !E.body.innerHTML) && --F) return r("requeing onLoad callback, DOM not available"), void setTimeout(s, 250);
                            var u = E.body ? E.body : E.documentElement;
                            g.responseText = u ? u.innerHTML : null, g.responseXML = E.XMLDocument ? E.XMLDocument : E, i && (f.dataType = "xml"), g.getResponseHeader = function(e) {
                                return {
                            ...
                            } else "xml" == l && !g.responseXML && g.responseText && (g.responseXML = O(g.responseText));
                            try {
                                L = C(g, l, f)
                            } catch (t) {
                                o = "parsererror", g.error = a = t || o
                            }
                        } catch (t) {
                            r("error caught: ", t), o = "error", g.error = a = t || o
                        }
            ...
            var u, c, f, m, p, h, v, g, x, b, y, T, S = l[0],
                w = !!e.fn.prop;
            if (e(":input[name=submit],:input[id=submit]", S).length) return void alert('Error: Form elements must not have name or id of "submit".');
            if (a)
                for (c = 0; c < d.length; c++) u = e(d[c]), w ? u.prop("disabled", !1) : u.removeAttr("disabled");
            if (f = e.extend(!0, {}, e.ajaxSettings, t), f.context = f.context || f, p = "jqFormIO" + (new Date).getTime(), f.iframeTarget ? (h = e(f.iframeTarget), b = h.attr("name"), b ? p = b : h.attr("name", p)) : (h = e('<iframe name="' + p + '" src="' + f.iframeSrc + '" />'), h.css({
                    position: "absolute",
                    top: "-1000px",
                    left: "-1000px"
                })), v = h[0], g = {
                    ...
                    abort: function(t) {
                        ...
                        if (r("aborting upload... " + a), this.aborted = 1, v.contentWindow.document.execCommand) try {
                ...
                }, m = f.global, m && 0 == e.active++ && e.event.trigger("ajaxStart"), m && e.event.trigger("ajaxSend", [g, f]), f.beforeSend && !1 === f.beforeSend.call(f.context, g, f)) return void(f.global && e.active--);
            if (!g.aborted) {
                x = S.clk, x && (b = x.name) && !x.disabled && (f.extraData = f.extraData || {}, f.extraData[b] = x.value, "image" == x.type && (f.extraData[b + ".x"] = S.clk_x, f.extraData[b + ".y"] = S.clk_y));
                var j = 1,
                    k = 2,
                    D = e("meta[name=csrf-token]").attr("content"),
                    A = e("meta[name=csrf-param]").attr("content");
                A && D && (f.extraData = f.extraData || {}, f.extraData[A] = D), f.forceSync ? o() : setTimeout(o, 10);
                var L, E, M, F = 50,
                    ...
                    C = function(t, a, r) {
                        var n = t.getResponseHeader("content-type") || "",
                            ...
                            i = o ? t.responseXML : t.responseText;
                        return o && "parsererror" === i.documentElement.nodeName && e.error && e.error("parsererror"), r && r.dataFilter && (i = r.dataFilter(i, a)), "string" == typeof i && ("json" === a || !a && n.indexOf("json") >= 0 ? i = X(i) : ("script" === a || !a && n.indexOf("javascript") >= 0) && e.globalEval(i)), i
                    }
            }
        }
        ...
        "function" == typeof t && (t = {
            success: t
        }), i = this.attr("method"), s = this.attr("action"), u = "string" == typeof s ? e.trim(s) : "", u = u || window.location.href || "", u && (u = (u.match(/^([^#]+)/) || [])[1]), t = e.extend(!0, {
            url: u,
        ...
        if (t.data && (t.extraData = t.data, m = e.param(t.data, f)), t.beforeSubmit && !1 === t.beforeSubmit(p, this, t)) return r("ajaxSubmit: submit aborted via beforeSubmit callback"), this;
        if (this.trigger("form-submit-validate", [p, this, t, c]), c.veto) return r("ajaxSubmit: submit vetoed via form-submit-validate trigger"), this;
        var h = e.param(p, f);
        ...
        t.success = function(e, a, r) {
            for (var n = t.context || this, o = 0, i = v.length; o < i; o++) v[o].apply(n, [e, a, r || l, l])
        };
        ...
        !1 !== t.iframe && (t.iframe || w) ? t.closeKeepAlive ? e.get(t.closeKeepAlive, function() {
            o(p)
        }) : o(p) : (b || T) && S ? function(r) {
            for (var n = new FormData, o = 0; o < r.length; o++) n.append(r[o].name, r[o].value);
            if (t.extraData) {
                var i = a(t.extraData);
                for (var s in i) i.hasOwnProperty(s) && n.append(s, i[s])
            }
            t.data = null;
        ...
        for (var j = 0; j < d.length; j++) d[j] = null;
        ...
        var o = this[0],
            i = t ? o.getElementsByTagName("*") : o.elements;
        if (!i) return r;
        var s, u, l, c, f, m, d;
        for (s = 0, m = i.length; s < m; s++)
            if (f = i[s], l = f.name)
                if (t && o.clk && "image" == f.type) f.disabled || o.clk != f || (r.push({
                    name: l,
                    value: e(f).val(),
                    type: f.type
                }), r.push({
            ...
            for (a && a.push(f), u = 0, d = c.length; u < d; u++) r.push({
                name: l,
                value: c[u]
            });
        ...
        } else null !== c && void 0 !== c && (a && a.push(f), r.push({
            name: l,
            value: c,
            type: f.type,
            required: f.required
        ...
        return this.each(function() {
            ...
            if (r) {
                ...
                if (n && n.constructor == Array)
                    for (var o = 0, i = n.length; o < i; o++) a.push({
                        name: r,
                        value: n[o]
                    });
        ...
        if (void 0 === a && (a = !0), a && (!r || t.disabled || "reset" == n || "button" == n || ("checkbox" == n || "radio" == n) && !t.checked || ("submit" == n || "image" == n) && t.form && t.form.clk != t || "select" == o && -1 == t.selectedIndex)) return null;
        if ("select" == o) {
            var i = t.selectedIndex;
            if (i < 0) return null;
            for (var s = [], u = t.options, l = "select-one" == n, c = l ? i + 1 : u.length, f = l ? i : 0; f < c; f++) {
                var m = u[f];
                if (m.selected) {
                    var d = m.value;
