$(function() {
    ...
    $('.jinsom-member-change-bg,.jinsom-member-change-bg-head .close').click(function() {
        if ($('.jinsom-member-change-bg-form').css('display') == 'none') {
            ...
            $(".jinsom-member-change-bg-form").animate({
                bottom: "0px"
            });
        } else {
            $(".jinsom-member-change-bg-form").animate({
            ...
            function d() {
                $(".jinsom-member-change-bg-form").hide();
            }
            setTimeout(d, 300);
        }
    });
...
<span>' + like_arr[i].time + '</span>\
    ...
    $('.jinsom-chat-header-user').click(function() {
        ...
        $(".jinsom-chat-content-group").animate({
            left: '240px'
        }, 250);
        $(".jinsom-chat-content-recent").animate({
            left: '240px'
        }, 250);
    ...
    //右侧、个人主页左侧工具悬浮
    $('.jinsom-content-right,.jinsom-member-left,.jinsom-publish-single-form .left').JinsomSidebarFixed({
    ...
    $(".tobottom").click(function() {
        $('html,body').animate({
            scrollTop: $('.jinsom-bottom').offset().top
        }, 500);
    });
    ...
    $(window).scroll(function() {
        ...
        if ((all_height - $(window).height() - height) < 300) {
            $(".tobottom").hide();
        } else {
            $(".tobottom").show();
        }
    ...
    clipboard.on('success', function(e) {
        ...
        function d() {
            $('#jinsom-copy-share-link').children('g').remove()
        }
        setTimeout(d, 1000);
    });
