(function() {
    ...
    (i = function() {
        ...
        return t.prototype.add_node = function(t) {
            ...
            for (e = this.parsed.length, this.parsed.push({
                    ...
                    disabled: t.disabled,
                    classes: t.className
                }), o = [], s = 0, i = (n = t.childNodes).length; s < i; s++) r = n[s], o.push(this.add_option(r, e, t.disabled));
            return o;
        ...
        var e, s, r, n, o;
        for (n = new i(), s = 0, r = (o = t.childNodes).length; s < r; s++) e = o[s], n.add_node(e);
        return n.parsed;
    }, e = function() {
        function t(e, s) {
            this.form_field = e, this.options = null != s ? s : {}, this.label_click_handler = r(this.label_click_handler, this), t.browser_is_supported() && (this.is_multiple = this.form_field.multiple, this.set_default_text(), this.set_default_values(), this.setup(), this.set_up_html(), this.register_observers(), this.on_ready());
        }
        return t.prototype.set_default_values = function() {
            ...
            var e, s, i, r, n, o, h;
            for (e = "", h = 0, r = 0, n = (o = this.results_data).length; r < n && (i = "", "" !== (i = (s = o[r]).group ? this.result_add_group(s) : this.result_add_option(s)) && (h++, e += i), (null != t ? t.first : void 0) && (s.selected && this.is_multiple ? this.choice_build(s) : s.selected && !this.is_multiple && this.single_set_selected_text(this.choice_label(s))), !(h >= this.max_shown_results)); r++);
            return e;
            ...
            var t, e, s, i, r;
            for (r = [], t = 0, e = (s = this.results_data).length; t < e; t++)(i = s[t]).selected ? r.push(i.selected = !1) : r.push(void 0);
            return r;
        ...
        return function(t, e) {
            ...
            var t, e, s, i, r, n, o, h, l, c, a, _, u, d, p, f, g, m, v, y, b, w, x, k;
            return this.container.on("touchstart.chosen", (t = this, function(e) {
                t.container_mousedown(e);
            })), this.container.on("touchend.chosen", (e = this, function(t) {
                e.container_mouseup(t);
            })), this.container.on("mousedown.chosen", (s = this, function(t) {
                s.container_mousedown(t);
            })), this.container.on("mouseup.chosen", (i = this, function(t) {
                i.container_mouseup(t);
            })), this.container.on("mouseenter.chosen", (r = this, function(t) {
                r.mouse_enter(t);
            })), this.container.on("mouseleave.chosen", (n = this, function(t) {
                n.mouse_leave(t);
            })), this.search_results.on("mouseup.chosen", (o = this, function(t) {
                o.search_results_mouseup(t);
            })), this.search_results.on("mouseover.chosen", (h = this, function(t) {
                h.search_results_mouseover(t);
            })), this.search_results.on("mouseout.chosen", (l = this, function(t) {
                l.search_results_mouseout(t);
            })), this.search_results.on("mousewheel.chosen DOMMouseScroll.chosen", (c = this, function(t) {
                c.search_results_mousewheel(t);
            })), this.search_results.on("touchstart.chosen", (a = this, function(t) {
                a.search_results_touchstart(t);
            })), this.search_results.on("touchmove.chosen", (_ = this, function(t) {
                _.search_results_touchmove(t);
            })), this.search_results.on("touchend.chosen", (u = this, function(t) {
                u.search_results_touchend(t);
            })), this.form_field_jq.on("chosen:updated.chosen", (d = this, function(t) {
                d.results_update_field(t);
            })), this.form_field_jq.on("chosen:activate.chosen", (p = this, function(t) {
                p.activate_field(t);
            })), this.form_field_jq.on("chosen:open.chosen", (f = this, function(t) {
                f.container_mousedown(t);
            })), this.form_field_jq.on("chosen:close.chosen", (g = this, function(t) {
                g.close_field(t);
            })), this.search_field.on("blur.chosen", (m = this, function(t) {
                m.input_blur(t);
            })), this.search_field.on("keyup.chosen", (v = this, function(t) {
                v.keyup_checker(t);
            })), this.search_field.on("keydown.chosen", (y = this, function(t) {
                y.keydown_checker(t);
            })), this.search_field.on("focus.chosen", (b = this, function(t) {
                b.input_focus(t);
            })), this.search_field.on("cut.chosen", (w = this, function(t) {
                w.clipboard_event_checker(t);
            })), this.search_field.on("paste.chosen", (x = this, function(t) {
                x.clipboard_event_checker(t);
            })), this.is_multiple ? this.search_choices.on("click.chosen", (k = this, function(t) {
                k.choices_click(t);
            ...
            })).on("click.chosen", (r = this, function(t) {
            ...
            if (this.is_multiple) {
                for (n = {
                        ...
                        display: "none",
                        whiteSpace: "pre"
                    }, s = 0, i = (o = ["fontSize", "fontStyle", "fontWeight", "fontFamily", "lineHeight", "textTransform", "letterSpacing"]).length; s < i; s++) n[r = o[s]] = this.search_field.css(r);
                return (e = t("<div />").css(n)).text(this.get_search_field_value()), t("body").append(e), h = e.width() + 25, e.remove(), this.container.is(":visible") && (h = Math.min(this.container.outerWidth() - 10, h)), this.search_field.width(h);
            }
        }, r.prototype.trigger_form_field_change = function(t) {
    ...
    function(t) {
        ...
        t.extend(e.prototype, {
            init: function(t, e, s) {
                this.controller = t, this.condition = e, this.value = s, this.rules = [], this.controls = [];
            },
            evalCondition: function(e, s, i, r, n) {
                if ("==" == i) return this.checkBoolean(r) == this.checkBoolean(n);
                if ("!=" == i) return this.checkBoolean(r) != this.checkBoolean(n);
                if (">=" == i) return Number(n) >= Number(r);
                if ("<=" == i) return Number(n) <= Number(r);
                if (">" == i) return Number(n) > Number(r);
                if ("<" == i) return Number(n) < Number(r);
                if ("()" == i) return window[r](e, s, n);
                if ("any" == i) {
                    if (s.length > 1 && n.length) {
                        for (var o = n.length - 1; o >= 0; o--)
                            if (-1 !== t.inArray(n[o], r.split(","))) return !0;
            ...
            checkCondition: function(t) {
                ...
                var e = t.find(this.controller),
                    s = this.getControlValue(t, e);
                return void 0 !== s && (s = this.normalizeValue(e, this.value, s), this.evalCondition(t, e, this.condition, this.value, s));
            },
            normalizeValue: function(t, e, s) {
                return "number" == typeof e ? parseFloat(s) : s;
            },
            getControlValue: function(t, e) {
                return e.length > 1 && ("radio" == e.attr("type") || "checkbox" == e.attr("type")) ? e.filter(":checked").map(function() {
                    return this.value;
                }).get() : "checkbox" == e.attr("type") || "radio" == e.attr("type") ? e.is(":checked") : e.val();
            },
            createRule: function(t, s, i) {
                var r = new e(t, s, i);
                return this.rules.push(r), r;
            },
            include: function(t) {
                this.controls.push(t);
            },
            applyRule: function(e, s) {
                var i;
                i = void 0 === s ? this.checkCondition(e) : s;
                var r = t.map(this.controls, function(t, s) {
                    return e.find(t);
                });
                i ? (t(r).each(function() {
                    t(this).removeClass("hidden");
                }), t(this.rules).each(function() {
                    this.applyRule(e);
                })) : (t(r).each(function() {
            ...
            enable: function(t, e, s) {
                return t.on("change", function(i) {
                    var r = i.target.getAttribute("data-depend-id") || i.target.getAttribute("data-sub-depend-id"); - 1 !== s.indexOf(r) && e.applyRules(t);
                }), e.applyRules(t), !0;
            }
        };
    }(jQuery),
    function(t, e) {
        if ("function" == typeof define && define.amd) define(["exports", "jquery"], function(t, s) {
            return e(t, s);
        });
