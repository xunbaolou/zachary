window.Player = function(e) {
    ...
    var h = function(e) {
        ...
        return function(e, t) {
            ...
            value: function() {
                ...
                this.video.load(), r.insertBefore(this.video, r.firstChild), setTimeout(function() {
    ...
    switch (/Windows/.test(x) && (m = D(/Windows (.*)/, x), x = "windows"), x) {
        case "Mac OS X":
            m = D(/Mac OS X (10[\.\_\d]+)/, p), x = "mac";
            break;
        case "Android":
            (C = D(/Android ([\.\_\d]+)/, _ = p)) || (C = D(/Android\/([\.\_\d]+)/, _)), m = C, x = "android";
            break;
        case "iOS":
        ...
        te = function(e) {
            function t() {
                ...
                return n.init = function(e) {
                    ...
                    n.logger = new N(o), n.logger.init(a), n.initConfigs(e), n.initUrls(r, i), n.setEnv("app_id", t)
    ...
    var fe = function() {
        ...
        ge = function e(t) {
            ...
            }, this._isSendFuncCalled = !1, this._autoSendPV = !0, this.name = t, this.logger = new N(t)
        };
                        ...
                        return r(e, [{
                            ...
                            value: function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                                    ...
                                    n = this;
                                n.resizeing || (n.resizeing = !0, setTimeout(function() {
                            ...
                            value: function(e) {
                                ...
                                if (e.options.realTime) {
                                    ...
                                    if (t.danmu.bulletBtn.main.queue.forEach(function(e, n) {
                                            e.el && e.el.getBoundingClientRect().right > t.containerPos.right && e.start >= D && (D = e.start, O = e)
                                        }), O) {
                                        e.channel_id = O.channel_id;
                                        for (var L = O.channel_id[0], M = O.channel_id[0] + O.channel_id[1]; L < M; L++)(s = r[L]).operating[e.mode] = !0, s.queue[e.mode].unshift(e), e.prior && delete s.bookId[e.mode], s.operating[e.mode] = !1;
                                        return e.top = O.top, t.danmu.config.area && t.danmu.config.area.start && (e.top += t.containerHeight * t.danmu.config.area.start), {
                                            result: e,
                                            message: "success"
                                        }
                                    }
        ...
        a && Array.isArray(a) && a.length > 0 && (n.addClass(e.root, "xgplayer-is-texttrack"), e.once("canplay", function() {
            ...
            r.addEventListener(t, function(t) {
                ...
                if (i && "li" === i.tagName.toLocaleLowerCase()) {
                    ...
                    "关闭" === i.innerHTML ? (o[0].track.mode = "hidden", o[0].src = "", n.removeClass(e.root, "xgplayer-texttrack-active")) : (o[0].style.display = "block", n.addClass(e.root, "xgplayer-texttrack-active"), o[0].track.mode = "showing", a.some(function(e) {
            ...
            e.hls && r && i && (i[0].src = "", Array.prototype.forEach.call(r.childNodes, function(e) {
                n.hasClass(e, "selected") && ("关闭" === e.innerHTML ? (i[0].track.mode = "hidden", i[0].src = "") : (i[0].track.mode = "hidden", a.some(function(t) {
                    if (t.label !== e.innerHTML) return i[0].src = t.src, t.kind && (i[0].kind = t.kind), i[0].label = t.label, t.srclang && (i[0].srclang = t.srclang), !0
                }), a.some(function(t) {
                    if (t.label === e.innerHTML) return setTimeout(function() {
                        i[0].src = t.src, t.kind && (i[0].kind = t.kind), i[0].label = t.label, t.srclang && (i[0].srclang = t.srclang), i[0].track.mode = "showing"
                    }), !0
                })))
