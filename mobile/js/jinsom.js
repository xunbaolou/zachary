...
if (mobile_page) {
    if (mobile_page.sns) {
        view_sns = myApp.addView('#jinsom-view-sns', {
            dynamicNavbar: true,
            domCache: true
        });
    }
    if (mobile_page.notice) {
        view_notice = myApp.addView('#jinsom-view-notice', {
            dynamicNavbar: true,
            domCache: true
        });
    }
    if (mobile_page.find) {
        view_find = myApp.addView('#jinsom-view-find', {
            dynamicNavbar: true,
            domCache: true
        });
    }
    if (mobile_page.mine) {
        view_mine = myApp.addView('#jinsom-view-mine', {
            dynamicNavbar: true,
            domCache: true
        });
    }
    if (mobile_page.bbs) {
        view_bbs = myApp.addView('#jinsom-view-bbs', {
            dynamicNavbar: true,
            domCache: true
        });
    }
    if (mobile_page.video) {
        view_video = myApp.addView('#jinsom-view-video', {
            dynamicNavbar: true,
            domCache: true
        });
    }
    if (mobile_page.single) {
        view_single = myApp.addView('#jinsom-view-single', {
            dynamicNavbar: true,
            domCache: true
        });
    }
    if (mobile_page.custom_1) {
        view_custom_1 = myApp.addView('#jinsom-view-custom-1', {
            dynamicNavbar: true,
            domCache: true
        });
    }
    if (mobile_page.custom_2) {
        view_custom_2 = myApp.addView('#jinsom-view-custom-2', {
            dynamicNavbar: true,
            domCache: true
        });
    }
    if (mobile_page.custom_3) {
        view_custom_3 = myApp.addView('#jinsom-view-custom-3', {
            dynamicNavbar: true,
            domCache: true
        });
    }
    ...
    if (jinsom.is_bbs_post) {
        function a() {
            myApp.getCurrentView().router.load({
                url: jinsom.theme_url + '/mobile/templates/page/post-bbs.php?post_id=' + jinsom.post_id + '&bbs_id=' + jinsom.bbs_id + '&url=' + jinsom.post_url + '&type=bbs'
            });
        }
        setTimeout(a, 500);
        ...
        function b() {
            myApp.getCurrentView().router.load({
                url: jinsom.theme_url + '/mobile/templates/page/post-words.php?post_id=' + jinsom.post_id + '&url=' + jinsom.post_url
            });
        }
        setTimeout(b, 500);
        ...
        function c() {
            myApp.getCurrentView().router.load({
                url: jinsom.theme_url + '/mobile/templates/page/post-' + jinsom.post_type + '.php?post_id=' + jinsom.post_id + '&url=' + jinsom.post_url
            });
        }
        setTimeout(c, 500);
    } else {
...
if (jinsom.is_page) {
    ...
    function e() {
        myApp.getCurrentView().router.load({
            url: jinsom.theme_url + '/mobile/templates/page/post-page.php?post_id=' + jinsom.post_id + '&page_template=' + jinsom.page_template + '&url=' + jinsom.post_url
        });
    }
    setTimeout(e, 500);
}
...
if (jinsom.is_author) {
    ...
    if (jinsom.user_id == jinsom.author_id) {
        function f() {
            myApp.getCurrentView().router.load({
                url: jinsom.theme_url + '/mobile/templates/page/member-mine.php?author_id=' + jinsom.author_id + '&url=' + jinsom.author_url
            });
        }
        setTimeout(f, 500);
    } else {
        function g() {
            myApp.getCurrentView().router.load({
                url: jinsom.theme_url + '/mobile/templates/page/member-other.php?author_id=' + jinsom.author_id + '&url=' + jinsom.author_url
            });
        }
        setTimeout(g, 500);
    }
...
if (jinsom.is_category) {
    ...
    function h() {
        myApp.getCurrentView().router.load({
            url: jinsom.theme_url + '/mobile/templates/page/bbs.php?bbs_id=' + jinsom.bbs_id + '&url=' + jinsom.bbs_url
        });
    }
    setTimeout(h, 500);
}
...
if (jinsom.is_tag) {
    ...
    function i() {
        myApp.getCurrentView().router.load({
            url: jinsom.theme_url + '/mobile/templates/page/topic.php?topic_id=' + jinsom.topic_id + '&url=' + jinsom.topic_url
        });
    }
    setTimeout(i, 500);
}
...
if (jinsom.is_search) {
    ...
    function j() {
        myApp.getCurrentView().router.load({
            url: jinsom.theme_url + '/mobile/templates/page/search.php?search_keywords=' + jinsom.search_keywords
        });
    }
    setTimeout(j, 500);
}
...
$('.jinsom-player-footer-btn .comment').click(function() {
    ...
    if (play_post_id) {
        ...
        myApp.getCurrentView().router.load({
            url: jinsom.theme_url + '/mobile/templates/page/comment-music-page.php?post_id=' + play_post_id
        });
    }
});
