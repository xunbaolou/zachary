    ...
    return function n(e, f, o) {
        ...
        14: [function(e, n) {
            ...
            f.prototype.cloneTo = function(e) {
                ...
                return "SELECT" === this.node.tagName ? e = o(this.node) : "password" === this.node.type && (e = Array(e.length + 1).join("鈥�")), 0 === e.length ? this.node.placeholder || "" : e
        ...
        15: [function(e, n) {
            ...
            f.prototype.calculateOverflowClips = function() {
                ...
                var n = e.parseBounds(),
                    ...
                    u = s(o, i, l);
                this.renderer.clip(e.backgroundClip, function() {
                    this.renderer.rectangle(o.left + 1, o.top + 1, o.width - 2, o.height - 2, new T("#DEDEDE")), this.renderer.renderBorders(t(l, o, u, i)), e.node.checked && (this.renderer.font(new T("#424242"), "normal", "normal", "bold", f - 3 + "px", "arial"), this.renderer.text("鉁�", o.left + f / 6, o.top + f - 1))
                }, this)
            ...
            reader.onload = function(event) {
                ...
                image.onload = function() {
                    ...
                    EXIF.getData(image, function() {
                        ...
                        var rotateBase64 = rotateCanvas.toDataURL("image/png", 0.9);
